...
exports.pool = exports.queryDB = exports.connectDB = void 0;
var pg_1 = require("pg");
var pool = new pg_1.Pool({
    user: 'postgres', // Replace with your PostgreSQL username
    host: 'localhost', // Replace with your PostgreSQL host
    database: 'zomato', // Replace with your database name
    password: 'Dishank@2309', // Replace with your PostgreSQL password
...
var queryDB = function (query, params) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                console.error('Database query error:', error_2); // Log the error
                throw error_2; // Re-throw the error to be caught in the service
            case 3: return [2 /*return*/];
        }
    });
}); };
